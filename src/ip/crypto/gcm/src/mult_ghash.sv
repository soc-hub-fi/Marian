...
//
// Inputs:
//  - multiplier_i : Multiplier (vd)
//  - multiplicand_i : Multiplicand (vs2)
//
// Outputs:
//  - product_o : Product
//
...
(
  input  logic              clk_i,
  input  logic              rst_ni,
  input  logic [EGW128-1:0] multiplier_i,
  input  logic [EGW128-1:0] multiplicand_i,
  input  logic              valid_i,

  output logic [EGW128-1:0] product_o,
  output logic              done_o
);
 ...
 **********************/
  ...
  assign Y_s         = brev8(multiplier_i);
  assign H_s[0]      = brev8(multiplicand_i);
  assign Z_s[0]      = '0;
 ...
 *********************/
  ...
  assign product_o = brev8(Z_s[EGW128]);

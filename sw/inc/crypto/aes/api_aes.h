...
#define AES128_BITS 128
#define AES256_BITS 256
...
void AES_encrypt_openssl(const unsigned char *in, unsigned char *out, const AES_KEY *key);

int AES_set_decrypt_key_openssl(const unsigned char *userKey, const int bits, AES_KEY *key);

void AES_decrypt_openssl(const unsigned char *in, unsigned char *out, const AES_KEY *key);

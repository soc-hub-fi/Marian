# ------------------------------------------------------------------------------
# axi_to_axi_lite_periph_ip_run.tcl
#
# Author(s): Tom Szymkowiak <thomas.szymkowiak@tuni.fi>
# Date     : 12-jan-2024
#
# Description: TCL script to synthesise the System AXI protocol converter IP.
# Conversion is full AXI to AXI-Lite, with a data width of 32b
# ------------------------------------------------------------------------------

# Clear the console output
puts "\n---------------------------------------------------------"
puts "axi_to_axi_lite_periph_ip_run.tcl - Starting..."
puts "---------------------------------------------------------\n"
...
eval list \
  ...
  CONFIG.ID_WIDTH "${AXI_S_ID_WIDTH}" \
] [get_ips ${IP_PROJECT}]
...
puts "\n---------------------------------------------------------"
puts "axi_to_axi_lite_periph_ip_run.tcl - Complete!"
puts "---------------------------------------------------------\n"

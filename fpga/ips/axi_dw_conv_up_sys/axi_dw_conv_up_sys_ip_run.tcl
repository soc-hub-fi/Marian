...
puts "\n---------------------------------------------------------"
puts "axi_dw_conv_up_sys_ip_run.tcl - Starting..."
puts "---------------------------------------------------------\n"
...
set AXI_S_DATA_WIDTH  64;
set AXI_M_DATA_WIDTH 128;
set AXI_S_ID_WIDTH     4;
...
puts "\n---------------------------------------------------------"
puts "axi_dw_conv_up_sys_ip_run.tcl - Complete!"
puts "---------------------------------------------------------\n"

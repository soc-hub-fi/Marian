//------------------------------------------------------------------------------
// Module   : axi_dw_conv_down_periph_wrapper
//
...
//              Converts AXI data from 128b to 32b.
//
// Parameters:
//  - None
//
...
//  - periph_resp_i: AXI resp signals coming in from peripherals (32b)
//
// Outputs:
//  - system_resp_o: AXI response signals going out to system xbar (128b)
//  - periph_req_o: AXI request signals going out to peripherals (32b)
//
// Revision History:
...
module axi_dw_conv_down_periph_wrapper (
  ...
  // mst_resp_i
  assign m_axi_awready_s = periph_resp_i.aw_ready;
  assign m_axi_arready_s = periph_resp_i.ar_ready;
  assign m_axi_wready_s  = periph_resp_i.w_ready;
  assign m_axi_bvalid_s  = periph_resp_i.b_valid;
  assign m_axi_bresp_s   = periph_resp_i.b.resp;
  assign m_axi_rvalid_s  = periph_resp_i.r_valid;
  assign m_axi_rdata_s   = periph_resp_i.r.data;
  assign m_axi_rresp_s   = periph_resp_i.r.resp;
  assign m_axi_rlast_s   = periph_resp_i.r.last;
  ...
  // mst_req_o
  assign periph_req_o.aw.id     = '0;
  assign periph_req_o.aw.addr   = m_axi_awaddr_s;
  assign periph_req_o.aw.len    = m_axi_awlen_s;
  assign periph_req_o.aw.size   = m_axi_awsize_s;
  assign periph_req_o.aw.burst  = m_axi_awburst_s;
  assign periph_req_o.aw.lock   = m_axi_awlock_s;
  assign periph_req_o.aw.cache  = m_axi_awcache_s;
  assign periph_req_o.aw.prot   = m_axi_awprot_s;
  assign periph_req_o.aw.qos    = m_axi_awqos_s;
  assign periph_req_o.aw.region = m_axi_awregion_s;
  assign periph_req_o.aw.atop   = '0;
  assign periph_req_o.aw.user   = '0;
  assign periph_req_o.aw_valid  = m_axi_awvalid_s;
  assign periph_req_o.w.data    = m_axi_wdata_s;
  assign periph_req_o.w.strb    = m_axi_wstrb_s;
  assign periph_req_o.w.last    = m_axi_wlast_s;
  assign periph_req_o.w.user    = '0;
  assign periph_req_o.w_valid   = m_axi_wvalid_s;
  assign periph_req_o.b_ready   = m_axi_bready_s;
  assign periph_req_o.ar.id     = '0;
  assign periph_req_o.ar.addr   = m_axi_araddr_s;
  assign periph_req_o.ar.len    = m_axi_arlen_s;
  assign periph_req_o.ar.size   = m_axi_arsize_s;
  assign periph_req_o.ar.burst  = m_axi_arburst_s;
  assign periph_req_o.ar.lock   = m_axi_arlock_s;
  assign periph_req_o.ar.cache  = m_axi_arcache_s;
  assign periph_req_o.ar.prot   = m_axi_arprot_s;
  assign periph_req_o.ar.qos    = m_axi_arqos_s;
  assign periph_req_o.ar.region = m_axi_arregion_s;
  assign periph_req_o.ar.user   = '0;
  assign periph_req_o.ar_valid  = m_axi_arvalid_s;
  assign periph_req_o.r_ready   = m_axi_rready_s;
  ...
  axi_dw_conv_down_periph i_axi_dw_conv_down_periph (
    // subordinate
    .s_axi_aclk     ( clk_i            ),
